SELECT
	...
	th.name AS thing_name, 
	th.description AS thing_description, 
	th.docs_link AS thing_docs_link, 
	th.parent_id AS thing_parent_id, 
	th.category_id AS thing_category_id,
	p.title AS parent_title, 
	p.thing_id AS parent_thing_id, 
	p.category_id AS parent_category_id, 
	p.description AS parent_description, 
	p.parent_id AS parent_parent_id, 
	p.created_at AS parent_created_at, 
	p.open AS parent_open, 
	p.updated_at AS parent_updated_at, 
	p.completed_at AS parent_completed_at
 FROM tickets t
